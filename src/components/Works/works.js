...
const works = () => {
  return (
        <section id='works'>
            ...
            <span className='worksDesc'>I take pride paying attention to the smallest details and making sure that my work is pixel perfect. I am excited to bring my skills and experience to help business achieve their goals and creating ther</span>
